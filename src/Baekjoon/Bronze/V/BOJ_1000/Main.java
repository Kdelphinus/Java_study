package Baekjoon.Bronze.V.BOJ_1000;
...
public class Main {
    ...
    public void solution() throws Exception {
        ...
        //br = new BufferedReader(new InputStreamReader(new FileInputStream("src/main/java/Baekjoon.Bronze.V.BOJ_1000.Main/input.txt"))); // 로컬 테스트용
